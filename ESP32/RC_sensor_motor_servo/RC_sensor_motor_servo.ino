...
sensorList_t sensors[] = {
    {&sensor1, &SENSOR1_WIRE, 0x30, 26, 32,
     Adafruit_VL53L0X::VL53L0X_SENSE_LONG_RANGE, 0, 0},
    {&sensor2, &SENSOR2_WIRE, 0x31, 27, 33,
     Adafruit_VL53L0X::VL53L0X_SENSE_HIGH_SPEED, 0, 0},
    {&sensor3, &SENSOR3_WIRE, 0x32, 25, 35,
...
#define REMOTEXY_WIFI_SSID "BR-88V1"
...
uint8_t RemoteXY_CONF[] =   // 194 bytes
  { 255,3,0,59,0,187,0,17,0,0,0,25,2,106,200,200,84,1,1,9,
  ...
  31,79,78,0,31,79,70,70,0,67,22,21,21,24,57,26,17,10,4,31,
  26,11,67,36,24,21,24,78,26,16,10,4,31,26,11,67,22,86,21,24,
  50,40,15,9,4,31,26,11,67,33,88,21,24,68,40,15,9,4,31,26,
  11,67,44,88,21,24,86,40,15,9,4,31,26,11 };
